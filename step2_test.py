...
def cal_miou(test_dir="DRIVE-SEG-DATA/Test_Images",
             ...
             model_path='/data1/limuci/code/cvlab/best_model_1_min.pth'):
    ...
    miou_out_path = "/data1/limuci/code/cvlab/unet_42-drive/results/"
...
if __name__ == '__main__':
    cal_miou(test_dir="DRIVE-SEG-DATA/Test_Images",  # 测试集路径
             ...
             model_path='/data1/limuci/code/cvlab/best_model_1_min.pth')  # 训练好的模型路径
